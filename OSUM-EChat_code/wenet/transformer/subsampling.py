...
class Conv1dSubsampling2(BaseSubsampling):
    ...
    def forward(
        ...
        # x = torch.load(
        #     "/mnt/sfs/asr/code/wenet_undersdand_and_speech_osum_echat/examples/wenetspeech/whisper/dump/gpu/step0/rank0/dump_tensor_data/Tensor.transpose.1.forward.output.0.pt")
        # x = x.to(x_old.device)
        x, pos_emb = self.pos_enc(x, offset)
